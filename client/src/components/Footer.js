            ...
            <div className="dashAboutUs">
                ...
                <div className="dash-mid dash-box">
                    ...
                    <ul className="dash-mail-id">
                        <li className="fa fa-envelope"><a href="iit2019227@iiita.ac.in">&ensp; iit2019227@iiita.ac.in </a></li>
                        <li className="fa fa-envelope"><a href="iit2019216@iiita.ac.in">&ensp; iit2019216@iiita.ac.in </a></li>
                        <li className="fa fa-envelope"> <a href="iit2019205@iiita.ac.in">&ensp;iit2019205@iiita.ac.in </a></li>
                        <li className="fa fa-envelope"><a href="iit2019219@iiita.ac.in">&ensp; iit2019219@iiita.ac.in </a></li>
                    </ul>
